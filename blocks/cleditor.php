...
<script type="text/javascript">
	$(document).ready(function() {
		$("#contest_rules").cleditor({
			width: 1024, // width not including margins, borders or padding
			height: 550, // height not including margins, borders or padding
			controls: // controls to add to the toolbar
				"undo redo | cut copy paste pastetext | bold italic underline strikethrough subscript superscript | font size " +
				"style | color highlight removeformat | bullets numbering " +
				"| alignleft center alignright justify | outdent indent | " +
